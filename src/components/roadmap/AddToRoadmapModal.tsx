...
import type { Roadmap, SuggestionHistoryItem } from '../../types';

interface AddToRoadmapModalProps {
  isOpen: boolean;
  onClose: () => void;
  roadmaps: Roadmap[];
  suggestion: SuggestionHistoryItem | null;
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Add to Roadmap</h2>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Add the learning path for "<span className="font-bold text-brand-purple">{suggestion.inputs.goals}</span>" to one of your existing roadmaps.
            </p>

            {roadmaps.length > 0 ? (
              <div className="space-y-3">
                <label className="text-sm font-semibold text-gray-500">Select a Roadmap</label>
            ...
            <div className="mt-8 flex justify-end space-x-3">
              ...
              <Button onClick={handleConfirm} disabled={!selectedRoadmapId}>Add to Roadmap</Button>
            </div>
          </motion.div>
        </motion.div>
      )}
